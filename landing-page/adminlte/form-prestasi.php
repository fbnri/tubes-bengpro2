...
if(isset($_POST['tambah'])) {
  ...
  if (isset($_FILES['ijazah']['name']))
  {
    ...
    // menghindari tabrakan nama file dengan menggunakan timestamp
    $nama_file_unik = time(). '_'. $file_name;
    move_uploaded_file($file_tmp,"../pdf/".$nama_file_unik);

    $sql = 
    "INSERT INTO pendaftar_reguler (nama_siswa, ttl, jk, alamat, telp_siswa, agama, asal_sekolah, ijazah, rapor, nama_ortu, pekerjaan, telp_ortu, pendidikan, prestasi) VALUES ('$nama_siswa', '$ttl', '$jk', '$alamat','$telp_siswa', '$agama', '$asal_sekolah', '$nama_file_unik', '$rapor', '$nama_ortu', '$pekerjaan', '$telp_ortu', '$pendidikan', '$prestasi')";
